...
Consider a two-sided z-test on a proportion $p$ based on $x$ successed in $n$
...
Compute the actual probability of a Type I error fo rthe procedure described for
...
```{r}
simulate <- function(n, p, alpha = 0.05, n_reps = 1000) {
  x <- rbinom(n_reps, n, p)
  p_hat <- x / n
